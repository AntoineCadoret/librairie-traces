...
export class HowtoTabs extends HTMLElement {
    ...
    constructor() {
        ...
        /**
         * Les styles suivants seront personnalisés selon la direction visuelle du projet
         * Les onglets ont 3 états possibles:
         * Au neutre, lorsqu'ils ne sont ni au focus ni en sélection ils sont gris
         * L'onglet au focus et en sélection se borde en orange
         * L'onglet hors focus mais en sélection se borde de bleu
         */
        ::slotted([role="tab"]) {
            position: relative;
            margin: 0;
